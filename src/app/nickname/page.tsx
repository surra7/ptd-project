        ...
        <div className="h-full w-full flex flex-col items-center justify-center">
          <section className="wrap-section w-full max-w-md">
            ...
            <div className="flex justify-between mt-4 w-full">
              <Link href="/profile">
                <button className="w-[1rem] ml-6 px-4 py-2  text-black rounded-md shadow-sm  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                  취소
                </button>
              </Link>
              <button
                onClick={handleNicknameChange}
                className="w-[1rem] px-4 py-2 bg-purple-600 text-white rounded-md shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                완료
              </button>
            </div>
          </section>
