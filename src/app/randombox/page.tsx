            ...
            {isBoxClicked ? (
              <div className="h-full flex flex-col animate-boxopen">
                <div className="h-2/3 flex items-end py-6 ">
                  <Image src={`https://api.petodo.today${randomImage}`} alt="randomImage" width={250} height={250} />
                </div>
                <div className="h-1/3">
                  <div className="text-center text-white text-4xl font-bold p-1 bg-primary-500">{randomName}</div>
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="h-1/3">
                  <div className="text-center text-white text-4xl font-bold p-1 drop-shadow-[0_4px_4px_rgba(129,51,234,100)]">
                    박스를 클릭하세요!
                  </div>
