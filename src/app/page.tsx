        ...
        <div
          ...
          <main className="w-full h-5/6 ">
            ...
            <section className="w-full h-1/3 flex flex-col items-center">
              ...
              {isTouchPet ? (
                  <Image src={'/pet/hand.png'} alt="heart" width={50} height={50} className="animate-shackHand" />
              ) : 
                (accessoryImageURL) && (
                  <Image src={`${accessoryImageURL}`} alt="accessory" width={40} height={40} className="object-contain items-end" />
                )
              }
              </div>
              <div className="flex w-full h-3/5 justify-center items-top">
                {/* {isLevelUp ? (
                  ...
                  <Image src={`${activePetImageURL}`} alt="pet" width={150} height={130} className="object-contain items-top" />
                {/* )} */}
              </div>
            </section>
